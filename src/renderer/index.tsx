...
const configurePdfWorker = () => {
  const workerUrl = '/pdf.worker.min.js'; // Local bundled worker
  
  try {
    // First try: Use local bundled worker
    pdfjsLib.GlobalWorkerOptions.workerSrc = workerUrl;
    console.log('PDF.js worker configured with local bundle');
  } catch (error) {
    console.warn('Failed to set local worker, trying CDN fallback');
    // Fallback to CDN
