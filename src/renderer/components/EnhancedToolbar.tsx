...
interface ToolbarProps {
  ...
  canUndo?: boolean;
  canRedo?: boolean;
  onToolOptionChange: (tool: string, options: any) => void; // New prop
}
...
const EnhancedToolbar: React.FC<ToolbarProps> = ({
  ...
  const renderIcon = (iconName: string, size: number = 16) => {
    const iconProps = { size, className: 'icon' };
    switch (iconName) {
      ...
      case 'Highlighter': return <Highlighter {...iconProps} />;
      ...
      case 'RadioButton': return <RadioButton {...iconProps} />;
