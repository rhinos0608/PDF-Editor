...
interface ElectronAPI {
  ...
  saveFile: (filePath: string, data: ArrayBuffer) => Promise<SaveFileResult>;
  saveFileDialog: (defaultName?: string) => Promise<SaveFileDialogResult>;
  getPreferences: () => Promise<any>;
  setPreferences: (prefs: any) => Promise<any>;
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onMenuAction: (callback: (action: string) => void) => {
    ...
    ipcRenderer.on('menu-action', (event: IpcRendererEvent, action: string) => callback(action));
  },
